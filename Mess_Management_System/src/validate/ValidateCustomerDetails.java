...
public class ValidateCustomerDetails {
	 ...
	 * b) Validatecustomer login if not exist or invalid mail & invalid password
	 * Email must be like regex provided in :
	 * "[A-Z0-9a-z._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}" e.g user1.dac@iacsd.com
	 */
	public static void ValidateCustomerEmailnPass(String email, String pass, Map<String, Customer> map)
	 ...
	 * date and end date must be depend on plan selected e.g if user reg date is
	 * 11/10/2023 and selected plan is of 1 year then end date set automatically as
	 * 11/12/2024
	 */
	...
	/*
	 * e) Phone number must be only 10 character and the number could be between 0
	 * to 9. hint:regex
	 */
	...
	// Validate All
	public static Customer ValidateAll(String fname, String lname, String email, String pass, String address,
			String regdate, String PhoneNo, String plan, double final_amt, Map<String, Customer> map)
